...
Equation
   ...
   mileconstraint1 'Constraint on x(1,1)'
   mileconstraint2 'Constraint on x(3,2)'
   mileconstraint3 'Constraint on x(3,3)'
   mileconstraint4 'Constraint on x(4,1)'
   mileconstraint5 'Constraint on x(6,2)';
...
mileconstraint1.. x('1','1') =e= 0;

mileconstraint2.. x('3','2') =e= 0;

mileconstraint3.. x('3','3') =e= 0;

mileconstraint4.. x('4','1') =e= 0;

mileconstraint5.. x('6','2') =e= 0;
